(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("theCollector", [], factory);
	else if(typeof exports === 'object')
		exports["theCollector"] = factory();
	else
		root["theCollector"] = factory();
})(window, function() {
...
Object.defineProperty(exports, "__esModule", { value: true });
__export(__webpack_require__(/*! ./hashString */ "./helpers/hashString.ts"));
__export(__webpack_require__(/*! ./bytesToSize */ "./helpers/bytesToSize.ts"));
...
var addToDom_1 = __webpack_require__(/*! ./addToDom */ "./src-client/addToDom.ts");
var helpers_1 = __webpack_require__(/*! ../helpers */ "./helpers/index.ts");
var reportEvent_1 = __webpack_require__(/*! ./reportEvent */ "./src-client/reportEvent.ts");
var timesStart = Date.now();
var timesDOM = 0;
var GUID = helpers_1.hashString(timesStart + "-" + location.host + "-" + location.pathname);
var naStr = "N/A";
var PAINT = {
    "first-paint": naStr,
...
var n1 = new UAParser(n.userAgent);
var AGENT = {
    guid: GUID,
...
if (!AGENT.client.device.type && AGENT.client.os.name) {
    ...
    if (navigator.userAgent.match(/mac/gim) ||
...
function crossTiming(v2, v1, fallback) {
    if (fallback === void 0) { fallback = naStr; }
    return v2 || v1 || fallback;
}
window.addEventListener("load", function (e) {
    setTimeout(function () {
        var p = performance.getEntries()[0];
        var p1 = performance.getEntriesByType("resource");
        var pv1 = performance.timing;
        var timesLoaded = Date.now() - timesStart;
        var timesDOMPolyfil = timesDOM - timesStart;
        var d = __assign({ size: {
                transferSizeKB: (p.transferSize / 1024).toFixed(2),
                decodedBodySizeKB: (p.decodedBodySize / 1024).toFixed(2),
                totalTransferSizeKB: (p1.reduce(function (a, b) { return a += b.transferSize; }, 0) / 1024).toFixed(2),
                totalDecodedBodySizeKB: (p1.reduce(function (a, b) { return a += b.decodedBodySize; }, 0) / 1024).toFixed(2)
            }, events: {
                dom: {
        ...
        addToDom_1.addToDom(GUID, d);
        reportEvent_1.reportEvent(d, GUID);
    });
});
...
Object.defineProperty(exports, "__esModule", { value: true });
var URL = "/collect";
function reportEvent(event, qstr) {
    var body = {
        metrics: event
    };
